export const ABOUT_COPY = {
  ...
  paragraphs: [
    ...
    "Whether you need gift ideas in USA or a gift for a picky colleague, our smart filters (interest, budget, occasion) deliver the right options in seconds. No more guesswork. Just the look of genuine surprise on their face.",
  ],
  stats: [
    {
      id: "recipients",
